      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#0f172a] border border-white/5 rounded-xl p-5 sticky top-[120px] h-fit">
          ...
          <div className="mb-6">
            ...
            {brands.map((b) => (
              <label key={b} className="flex gap-2 text-sm text-gray-300 mb-2">
                <input
                  type="checkbox"
          ...
          <div>
            ...
            {[4, 3, 2].map((r) => (
              <label key={r} className="flex gap-2 text-sm text-gray-300 mb-2">
          ...
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="flex gap-3 items-center flex-wrap">
              ...
              <select
                ...
                className="bg-[#020617] border border-white/10 text-gray-300 px-3 py-1 rounded text-sm"
              >
